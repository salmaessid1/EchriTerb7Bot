...
import com.example.echriterbe7bot.ForgetPassActivity;
import com.example.echriterbe7bot.R;
import com.example.echriterbe7bot.SignUpActivity;
...
public class SignInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gotoProfil = findViewById(R.id.editProfil);
        ...
        gotoProfil.setOnClickListener(v -> {
    ...
    private void checkEmailVerification() {
        ...
        if (loggedUser != null) {
            if (loggedUser.isEmailVerified()) {
                startActivity(new Intent(SignInActivity.this, AccueilActivity.class));
                progressDialog.dismiss();
                finish();
            } else {
